...
export const carousel = (options: any = {}) => {
  ...
  noo.comp = doElement(
    `<div class="dds__carousel" id="${optId}" aria-label="${optAriaLabel}" role="region" aria-atomic="false" data-dds="carousel">`
  );
  noo.comp.controls = doElement(
  ...
  noo.comp.wrapper.track = doElement(
